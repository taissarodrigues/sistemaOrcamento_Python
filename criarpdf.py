...
class SalesInvoice():
    def __init__(self,company,
                 ...
                 logo,total,discount,payment,
                 rest,client,clientAddress,
                 invoiceNumber) -> None:
        d_ate = date.today()
        ...
        my_canvas.drawString(24, 703, 'Endereço :')
        # my_canvas.drawString(75, 703, clientAddress)
        ...
        my_canvas.drawCentredString(144, 657, 'Produto')
        my_canvas.drawCentredString(250, 657, 'Quantidade')
        my_canvas.drawCentredString(350, 657, 'Preço')
        my_canvas.drawCentredString(490, 657, 'Quantidade')
        ...
        my_canvas.drawRightString(500, line_y-50, 'Pagamento:')
