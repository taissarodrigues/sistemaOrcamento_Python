...
from criarpdf import SalesInvoice
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def createInvoice(self):
        SalesInvoice(self.companyName.text(), self.email.text(), self.phone.text(),
                     self.companyAddress.toPlainText().strip(), self.table, self.logoFile, self.total.text(
            ), self.discount.text(), self.payment.text(), self.rest.text(), self.client.text(),
                     self.address_client.text(), self.n_invoice.text())
    ...
    def company_label(self):
        if self.companyName.text() == "":
            ...
            self.label.setText("NOME DA EMPRESA")
    ...
    def quantity_label(self):
        if self.quantity.text() == "":
            ...
            self.label_17.setText("Quantidade")
